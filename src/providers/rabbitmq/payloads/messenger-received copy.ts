...
interface Payload {
  template_type?: string; // Tipo de anexo. Pode ser image, audio, video, file, template ou fallback.
  ...
  buttons?: any[]; // Botões do anexo. Aplicável ao tipo de anexo template.
}

interface Attachment {
  type: "template" | "image" | "fallback" | "file" | "audio" | "video"; // Tipo de anexo, que pode ser image, audio, video, file ou location
...
export interface MessengerReceivedDto {
